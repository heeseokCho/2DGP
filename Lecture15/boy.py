...
class WalkingState:
    ...
    def do(boy):
        ...
        collide_left = boy.x
        collide_left = boy.y
        left_collide = (1046-81)/(211-27)
        right_collide = (78 - 1038)/(1755-1618)
        #left top = 211, 1046
        #left_bottom = 27,81
        #right_bottom 1755, 78
        #right Top = 1618,1038,

        boy.x = clamp((1/left_collide) * boy.y,boy.x,(1/right_collide) * boy.y+boy.bg.w-50)
